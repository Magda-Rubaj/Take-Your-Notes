"""
Django settings for take_your_notes project.
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'take_your_notes', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                ...
                'take_your_notes.apps.core.context_processors.category_context',
            ],
        },
    },
]

WSGI_APPLICATION = 'take_your_notes.wsgi.application'
